...
insert into keepcoding.coches_auxiliar (matricula,grupo,marca,modelo,fecha_compra,color,aseguradora,n_poliza,fecha_alta_seguro,importe_revision,moneda,kms_revision,fecha_revision,kms_totales) values
...
-- Borrado de tabla auxiliar
drop table keepcoding.coches_auxiliar;
